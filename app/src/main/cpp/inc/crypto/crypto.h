...
#define AES_ROUNDS 10  // AES-128的轮数
#define AES_KEY_SIZE 16  // AES-128的密钥长度
// AES上下文结构体
typedef struct {
    uint32_t round_key[4 * (AES_ROUNDS + 1)];  // 轮密钥
} AES_CTX;
...
size_t AES_get_padded_length(size_t input_length);
