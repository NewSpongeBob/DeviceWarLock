...
public class StatInfoCollector extends BaseCollector {
    ...
    public void collect() {
        try {
            ...
            XLog.e("SerialBlacklistCollector", "Failed to collect stats: " + e.getMessage());
            putFailedInfo("a30");
            putFailedInfo("a31");
        }
        try {
            ...
            putFailedInfo("a35");
            putFailedInfo("a36");
            XLog.e("StatInfoCollector", "Failed to collect keychain stats: " + e.getMessage());
        }
        try {
            ...
            XLog.e("StatInfoCollector", "Failed to check Apppackage: " + e.getMessage());
            putFailedInfo("a40");
        }
        try {
            ...
            XLog.e("StatInfoCollector", "Failed to collect download path stats: " + e.getMessage());
            putFailedInfo("a37");
        }
        try {
            ...
            XLog.e("StatInfoCollector", "Failed to collect sdcard android path stats: " + e.getMessage());
            putFailedInfo("a38");
        }
        try {
            ...
            XLog.e("StatInfoCollector", "Failed to collect /data/local/tmp path stats: " + e.getMessage());
            putFailedInfo("a39");
        }
        /**
...
//        }
    ...
    private String extractTimestamp(String line) {
        try {
            ...
            XLog.e("KeychainStatCollector", "Failed to extract timestamp: " + e.getMessage());
        }
        return "-1";
    }
}
